		...
		<main>
			<div class="container">
				...
				<form id="noticeForm" method="post">
					...
					<input type="hidden" name="board_type_id" value="${param.board_type_id}">
					<%-- 타이틀 --%>
					<div class="my-4">
						<label>제목</label>
					...
					<div class="my-4">
						<label>첨부파일</label>
						<input name="fileList" multiple="multiple" type="file" class="form-control" id="fileInput"> 
					</div>
					<%-- 콘텐츠 --%>
					<div class="mb-4">
						<label>내용</label>
					...
					<%-- 지도 --%>
					<c:if test="${param.board_type_id == 4}">
						<label>위치</label>	
						<div class="form-group mb-4">
							<input id="road_address_name" name="address_name" value="" type="text" class="form-control bg-white" readonly="readonly">
						</div>
						<div>
				...
				<div class="mb-4 d-flex justify-content-end">
					<button id="goBackBtn" type="button" class="btn btn-white border border-dark me-4">취소</button>
					<button id="regBtn" type="button" class="btn btn-primary">작성 완료</button>
				</div>
			</div>
		</main>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#regBtn").click(function () {
			...
			$("#noticeForm").attr("action", "/board_write").submit()
