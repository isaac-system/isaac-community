    ...
    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <div class="d-flex">
                ...
                <button type="button" class="btn btn-primary p-1" onclick="searchPlaces()"><span>검색</span></button> 
            </div>
        </div>
        <hr>
        <ul id="placesList"></ul>
...
$(document).on('click', '#addressBtn', function () {
	...
	var road_address = $(this).find("#roadAddress").text()
	
	$("#road_address_name").val(road_address)
